...
//     */
//    public void notifyNewRoomCreated(ChatRoomResponse newRoomData, List<String> memberUserIds) {
...
//            );
//            System.out.println("Sent new room notification to user: " + userId + " for room: " + newRoomData.getOwnerId());
//        }
//    }
//}
